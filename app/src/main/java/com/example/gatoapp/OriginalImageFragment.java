...
public class OriginalImageFragment extends Fragment {
    ...
    public static OriginalImageFragment newInstance(Uri uri) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_original_image, container, false);
        imageView = rootView.findViewById(R.id.imgOriginalPhoto);
