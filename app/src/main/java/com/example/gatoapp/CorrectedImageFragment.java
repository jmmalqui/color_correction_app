...
public class CorrectedImageFragment extends Fragment {
    ...
    public static CorrectedImageFragment newInstance(Uri uri) {
        CorrectedImageFragment fragment = new CorrectedImageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_corrected_image, container, false);
        imageView = rootView.findViewById(R.id.imgCorrectPhoto);
